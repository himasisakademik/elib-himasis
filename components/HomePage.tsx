...
const textArray = [
  "Hi Verse adalah media platform pembelajaran berbasis digital. Dirancang untuk membantu mahasiswa dalam mengakses referensi akademik dengan mudah.",
  "Temukan berbagai buku, jurnal, dan materi kuliah di Si Verse. Belajar jadi lebih efisien dengan akses tanpa batas.",
  "Dengan Hi Verse, belajar kapan saja dan di mana saja jadi lebih fleksibel. Dapatkan sumber belajar terbaik untuk menunjang akademik Anda.",
];
