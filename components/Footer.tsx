...
const Footer: React.FC = () => {
  ...
  return (
    <>
      <footer 
        ref={ref}
        className="relative bg-gradient-to-br from-slate-950 via-gray-900 to-slate-950 text-white overflow-hidden"
      >
        ...
        >
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4 mb-8 justify-center">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    title={social.label}
                  >
                    <social.icon className={`text-base sm:text-lg text-gray-400 ${social.color} transition-colors duration-300`} />
                  </motion.a>
                ))}
              </div>
          ...
          <motion.div 
            className="pt-8 sm:pt-12 mt-12 sm:mt-16 border-t border-white/10"
            variants={itemVariants}
          >
