  ...
  return (
    <section className="bg-gray-900 py-16 px-8">
      <div className="max-w-4xl mx-auto p-8 rounded-lg shadow-xl bg-gray-800">
        <h2 className="text-3xl font-semibold text-center text-white mb-8">Upload Materi</h2>
        <form onSubmit={handleSubmit} className="space-y-6">
          <input
            ...
            className="w-full p-4 border border-gray-300 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-700 text-white"
          />
          <input
            type="text"
            name="semester"
